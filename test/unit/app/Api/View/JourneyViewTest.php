...
class JourneyViewTest extends PHPUnit_Framework_TestCase {
    ...
    public function testArrivalAfterMidnight() {
        $jp = new JourneyView(
            new Journey([
                new Leg([new NonTimetableConnection("MAR", "PDW", 100)]),
                new Leg([new TimetableConnection("PDW", "TON", 80000, 80150, "SE1", "LN")]),
                new Leg([new TimetableConnection("TON", "SEV", 80150, 80250, "SE2", "LN"),
                         new TimetableConnection("SEV", "WAE", 80250, 100280, "SE2", "LN")]),
            ])
        );
